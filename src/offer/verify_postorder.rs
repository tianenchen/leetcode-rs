...
impl Solution {
    ...
    fn help(start:i32,end:i32,postorder :&Vec<i32>)->bool{
        ...
        Self::help(start as i32, bound as i32-1, &postorder)&&Self::help(bound as i32,end as i32-1, &postorder)
    }
...
fn check() {
    ...
    assert_eq!(Solution::verify_postorder(vec![4, 8, 6, 12, 16, 14, 10]),true);
}
