            ...
            if comparing {
                if va == vb {
                    Self::help(
                        ...
                        &(*b.as_ref().unwrap()).borrow().left,
                        comparing,
                    ) && Self::help(
                        &(*a.as_ref().unwrap()).borrow().right,
                        &(*b.as_ref().unwrap()).borrow().right,
                        comparing,
                    )
                } else {
                    false
                ...
                if va == vb {
                    ...
                    Self::help(&(*a.as_ref().unwrap()).borrow().left, b, comparing)
                        || Self::help(&(*a.as_ref().unwrap()).borrow().right, b, comparing)
                }
            }
        }
    }
